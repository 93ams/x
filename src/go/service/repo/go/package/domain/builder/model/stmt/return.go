...
func (b *returnDecsBuilder) Start(d model.Decorations) ReturnDecsBuilder { b.T.Start = d; return b }
func (b *returnDecsBuilder) End(d model.Decorations) ReturnDecsBuilder   { b.T.End = d; return b }
