...
import (
	"bufio"
	"fmt"
	model2 "github.com/tilau2328/x/src/go/service/repo/go/package/adaptor/driver/domain/model"
	"github.com/tilau2328/x/src/go/service/repo/go/package/adaptor/driver/model"
	model3 "github.com/tilau2328/x/src/go/service/repo/go/package/domain/model"
	"io"
	"strings"
)
...
func (p *Printer) File(dst io.Writer, e model3.File) error {
	i := strings.Repeat(Indent, indent)
